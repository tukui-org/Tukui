		...
		for i=1, numScores do
			...
			if ( name ) then
				if ( name == UnitName("player") ) then
					...
					if GetRealZoneText() == L.bg_arathi then 
					...
					elseif GetRealZoneText() == L.bg_warsong then 
					...
					elseif GetRealZoneText() == L.bg_eye then 
						GameTooltip:AddDoubleLine(L.datatext_flagscaptured,GetBattlefieldStatData(i, 1),1,1,1)
					elseif GetRealZoneText() == L.bg_alterac then
					...
					elseif GetRealZoneText() == L.bg_strand then
					...
					elseif GetRealZoneText() == L.bg_isle then
						GameTooltip:AddDoubleLine(L.datatext_basesassaulted,GetBattlefieldStatData(i, 1),1,1,1)
						GameTooltip:AddDoubleLine(L.datatext_basesdefended,GetBattlefieldStatData(i, 2),1,1,1)
					end					
					GameTooltip:Show()
