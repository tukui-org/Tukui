...
function ActionBars:ShowAllButtons(bar, num)
	...
	if (num == 2 or num == 3) then
		bar:Width((ActionButton1:GetWidth() * 6) + (C.ActionBars.ButtonSpacing * 7))
	elseif (num == 5) then
		bar:Height((ActionButton1:GetWidth() * 12) + (C.ActionBars.ButtonSpacing * 13))
	end
end
...
function ActionBars:RemoveColumn(bar, num)
	...
	bar:Width((ActionButton1:GetWidth() * (bar.NextColumnToHide - 1)) + (C.ActionBars.ButtonSpacing * bar.NextColumnToHide))
...
function ActionBars:RemoveButton(bar, num)
	...
	bar:Height((ActionButton1:GetWidth() * (bar.NextButtonToHide - 1)) + (C.ActionBars.ButtonSpacing * bar.NextButtonToHide))
...
function ActionBars:ShowTopButtons(bar)
	...
	bar:Height((ActionButton1:GetWidth() * 2) + (C.ActionBars.ButtonSpacing * 3))
end
...
function ActionBars:HideTopButtons()
	...
	Bar2:Height((ActionButton1:GetWidth() * 1) + (C.ActionBars.ButtonSpacing * 2))
	Bar3:Height((ActionButton1:GetWidth() * 1) + (C.ActionBars.ButtonSpacing * 2))
end
	...
	if (Bar:IsVisible()) then
		if (ShiftClick and Num ~= 4) then -- Handle shift-clicks on the button
			...
			if (Num == 4) then
				...
				BarButtons[2]:Height((ActionButton1:GetWidth() * 1) + (C.ActionBars.ButtonSpacing * 2))
				BarButtons[3]:Height((ActionButton1:GetWidth() * 1) + (C.ActionBars.ButtonSpacing * 2))
			end
			...
			elseif (Num == 5) then
				self:Size(ActionButton1:GetWidth(), Bar:GetHeight() - 40)
		...
		if (Num == 4) then
			...
			BarButtons[2]:Height((ActionButton1:GetWidth() * 2) + (C.ActionBars.ButtonSpacing * 3))
			BarButtons[3]:Height((ActionButton1:GetWidth() * 2) + (C.ActionBars.ButtonSpacing * 3))
		end
