...
-- Name is stored for identification but not further used (string?)
-- AddDefaultWidgets needs to add all default widgets (function)
local function newManager(Name, AddDefaultWidgets)
	local manager = {}
	Widgets[manager] = {
		_Count = 0,
...
UnitFrames.newWidgetManager = newManager
