...
function Bags:CreateContainer(storagetype, ...)
	...
	if (storagetype == "Bag") then
		...
		CostText:SetPoint("BOTTOMLEFT", 40, 10)
		...
		Purchase:SetWidth(Container:GetWidth() + 25)
		Purchase:SetHeight(70)
		Purchase:SetPoint("BOTTOMLEFT", SwitchReagentButton, "TOPLEFT", -25, 2)
		Purchase:CreateBackdrop()
		Purchase.Backdrop:SetPoint("TOPLEFT", 25, 0)
