...
local NamePlates = function(self)
	...
	Window:CreateColorSelection("All", "NamePlates", "AggroColor1", "Health Color: not tanking, lower threat than tank")
	Window:CreateColorSelection("All", "NamePlates", "AggroColor2", "Health Color: not tanking, higher threat than tank")
	Window:CreateColorSelection("All", "NamePlates", "AggroColor3", "Health Color: insecurely tanking, another unit have higher threat but not tanking")
	Window:CreateColorSelection("All", "NamePlates", "AggroColor4", "Health Color: securely tanking, highest threat")
...
local Raid = function(self)
	...
	Window:CreateSwitch("All", "Raid", "DesaturateNonPlayerBuffs", "Display other's buffs grayscaled")
...
local UnitFrames = function(self)
	...
	Window:CreateSwitch("Retail", "UnitFrames", "HealComm", "Enable HealComm")
