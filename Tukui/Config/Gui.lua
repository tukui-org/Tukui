...
local Raid = function(self)
	...
	Window:CreateSlider("Raid", "MaxUnitPerColumn", "Set max units per column [RAID 1->25]", 1, 15, 1)
	Window:CreateSlider("Raid", "WidthSize", "Set unit width [RAID 1->25]", 79, 150, 1)
	Window:CreateSlider("Raid", "HeightSize", "Set unit height [RAID 1->25]", 45, 150, 1)
	Window:CreateSlider("Raid", "Raid40MaxUnitPerColumn", "Set max units per column [RAID 26->40]", 1, 15, 1)
	Window:CreateSlider("Raid", "Raid40WidthSize", "Set unit width for [RAID 26->40]", 79, 150, 1)
	Window:CreateSlider("Raid", "Raid40HeightSize", "Set unit height [RAID 26->40]", 45, 150, 1)
