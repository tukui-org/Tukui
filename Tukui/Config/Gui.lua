...
local Misc = function(self)
	...
	Window:CreateSlider("Misc", "FadeWorldMapAlpha", "Worldmap opacity while moving", 0, 100, 1)
...
local NamePlates = function(self)
	...
	Window:CreateSection("Threat indicator")
	Window:CreateSwitch("NamePlates", "ColorThreat", "Enable nameplate coloring by threat")
	Window:CreateColorSelection("NamePlates", "AggroColor1", "Health Color: not tanking, lower threat than tank")
	Window:CreateColorSelection("NamePlates", "AggroColor2", "Health Color: not tanking, higher threat than tank")
	Window:CreateColorSelection("NamePlates", "AggroColor3", "Health Color: insecurely tanking, another unit have higher threat but not tanking")
	Window:CreateColorSelection("NamePlates", "AggroColor4", "Health Color: securely tanking, highest threat")
...
local Raid = function(self)
	...
	Window:CreateSlider("Raid", "Raid40WidthSize", "Set unit width", 79, 150, 1)
	Window:CreateSlider("Raid", "Raid40HeightSize", "Set unit height", 45, 150, 1)
	...
	Window:CreateSlider("Raid", "HighlightSize", "Set raid highlight size", 5, 15, 1)
...
local UnitFrames = function(self)
	...
	Window:CreateSwitch("UnitFrames", "PlayerDebuffs", "Enable player debuffs")
	...
	Window:CreateSwitch("UnitFrames", "TargetBuffs", "Enable target auras")
	Window:CreateSwitch("UnitFrames", "TargetDebuffs", "Enable target debuffs")
	...
	Window:CreateSwitch("UnitFrames", "FlashRemovableBuffs", "Flash enemy buffs that can be dispelled/purged/stealed")
