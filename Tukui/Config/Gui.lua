...
local ActionBars = function(self)
	...
	Window:CreateSwitch("Retail", "ActionBars", "Bar6", "Enable right bar #3")
	Window:CreateSwitch("Retail", "ActionBars", "Bar7", "Enable right bar #4")
	Window:CreateSwitch("Retail", "ActionBars", "Bar8", "Enable right bar #5")
	...
	Window:CreateSlider("Retail", "ActionBars", "Bar6ButtonsPerRow", "Bar #6, number of buttons per row", 1, 12, 1)
	Window:CreateSlider("Retail", "ActionBars", "Bar7ButtonsPerRow", "Bar #7, number of buttons per row", 1, 12, 1)
	Window:CreateSlider("Retail", "ActionBars", "Bar8ButtonsPerRow", "Bar #8, number of buttons per row", 1, 12, 1)
	...
	Window:CreateSlider("Retail", "ActionBars", "Bar6NumButtons", "Bar #6, number of buttons needed?", 1, 12, 1)
	Window:CreateSlider("Retail", "ActionBars", "Bar7NumButtons", "Bar #7, number of buttons needed?", 1, 12, 1)
	Window:CreateSlider("Retail", "ActionBars", "Bar8NumButtons", "Bar #8, number of buttons needed?", 1, 12, 1)
...
local UnitFrames = function(self)
	...
	Window:CreateSwitch("Cata", "UnitFrames", "ClassBar", "Enable class bar (example: holy power)")
