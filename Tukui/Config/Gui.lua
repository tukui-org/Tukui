...
local Raid = function(self)
	...
	Window:CreateSlider("Raid", "MaxUnitPerColumn", "Set max units per column |cffffff00[RAID 1->20]|r", 1, 15, 1)
	Window:CreateSlider("Raid", "WidthSize", "Set unit width |cffffff00[RAID 1->20]|r", 79, 150, 1)
	Window:CreateSlider("Raid", "HeightSize", "Set unit height |cffffff00[RAID 1->20]|r", 45, 150, 1)
	Window:CreateSlider("Raid", "Padding40", "Spacing in pixels between units |cffffff00[RAID 1->20]|r", 0, 20, 1)
	Window:CreateSlider("Raid", "Raid40MaxUnitPerColumn", "Set max units per column |cf00fff00[RAID 20->40]|r", 1, 15, 1)
	Window:CreateSlider("Raid", "Raid40WidthSize", "Set unit width for |cf00fff00[RAID 20->40]|r", 79, 150, 1)
	Window:CreateSlider("Raid", "Raid40HeightSize", "Set unit height |cf00fff00[RAID 20->40]|r", 45, 150, 1)
	Window:CreateSlider("Raid", "Padding40", "Spacing in pixels between units |cf00fff00[RAID 20->40]", 0, 20, 1)
