...
if T.client == "esES" then
	...
	L.install_header_4 = "3. Caracteristicas"
	...
	L.install_init_line_2 = "Se te guiará a través de un proceso de instalación en simples pasos. En cada uno de ellos podrás decidir que quieres y que no quieres aplicar o saltar ese paso."
	...
	L.tutorial_step_4_line_2 = "El borde del Minimapa cambia de color. Es verde cuando tienes un nuevo correo, rojo cuando tienes una invitación nueva en el calendario, y naranja cuando tienes ambas."
	...
	L.tutorial_step_4_line_4 = "Hay un menú desplegable disponible. Haciendo click derecho en el botón [X] (Cerrar) de la bolsa abrirá un menú desplegable para mostrar las bolsas, organizar objetos, mostrar llavero, etc. Haciendo click con la rueda del ratón en el Minimapa mostrará el micro menú."
	L.tutorial_step_5_line_1 = "Finalmente, Tukui incluye diversos comandos utiles. Debajo hay una lista."
	L.tutorial_step_5_line_2 = "/moveui te permite mover un montón de marcos por toda la pantalla. /enable y /disable se usan para activar o desactivar rapidamente los addons. /rl recarga la interfaz. /heal activa los marcos de banda de sanador y /dps activa los de dps/tanque."
	L.tutorial_step_5_line_3 = "/tt te permite susurrar a tu objetivo. /rc inicia una comprobacion de disponibilidad (Listos). /rd deshace el grupo o banda. /bags muestra algunas de las caracteristicas disponibles a traves de linea de comandos. /ainv activa la invitación automática cuando te susurren. (/ainv off) lo desactiva."
	...
	L.tutorial_step_6_line_2 = "Sugiero que hagas un vistazo en config/config.lua o escribiendo /Tukui para adaptar la interfaz a tus necesidades."
	L.tutorial_step_6_line_3 = "¡Puedes continuar instalando la UI si aun no esta hecho o si quieres dejarla como viene por defecto!"
	...
	L.install_step_1_line_3 = "Esto se |cffff0000recomienda|r para cualquier usuario, a menos que desees aplicar únicamente una parte de la configuración."
	...
	L.install_step_3_line_2 = "Este paso se |cffff0000recomienda|r para cualquier usuario nuevo."
	...
	L.install_step_4_line_4 = "¡Disfruta de Tukui! ¡Visitanos en http://www.tukui.org!"
