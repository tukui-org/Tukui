...
if T.client == "frFR" then
	...
	L.install_init_line_3 = "Vous avez également la possibilité de voir un bref tutoriel sur quelques caractéristiques de Tukui."
	...
	L.tutorial_step_2_line_1 = "Tukui comprends une version embarquée de oUF créé par Trond (Haste) A Ekseth. Ceci manipule beaucoup de Unitframe sur l'écran, les buffs et debuffs, et les éléments spécifiques à une classe."
	...
	L.tutorial_step_2_line_4 = "La façon la plus simple de bouger les Unitframes, entrer juste /moveui."
	...
	L.tutorial_step_3_line_2 = "Parce que tout le monde n'apprécie pas des addons comme les DPS meters, Boss mods, gestion des menaces, etc, nous jugeons que c'est la meilleure chose à faire. Tukui est réalisé dans l'idée de s'adapter au maximum de classes, rôles, spécialisation, type de jeu, goûts des joueurs, etc. C'est pourq Tuikui est l'une des interfaces les plus populaires du moment. Cela convient à tout style de jeu et est éditable à souhait. C'est aussi présenté afin d'être un bon départ pour celui qui veut faire sa propre interface personnalisée sans dépendre d'autres addons. Des tonnes d'utilisateurs depuis 2009 utilisent désormais Tukui comme une base pour leur propre interface. Allez faire un tour dans notre 'Edited Packages' sur notre site!"
	L.tutorial_step_3_line_3 = "Les utilisateurs peuvent vouloir visiter notre section 'extra mods' sur notre site ou en visitant http://www.wowinterface.com pour installer d'autres caractéristiques ou mods."
	L.tutorial_step_3_line_4 = ""

	L.tutorial_step_4_line_1 = "Pour définir le nombres de barres que vous voulez, placer votre souris sur la gauche, droite ou le dessous du cadre de fond de la barre d'action. Faites la même chose sur la droite de l'écran, en haut ou en bas du cadre. Pour copier le texte de la fenêtre de dialogue, cliquez sur le bouton vu en passant la souris sur le coin droit de la fenêtre de discussion."
	L.tutorial_step_4_line_2 = "Les bords de la mini carte changent de couleur. C'est vert lorsque vous avez du courrier, rouge lorsque vous avez une nouvelle invitation calendrier, orange lrosque ce sont les deux."
	...
	L.tutorial_step_4_line_4 = "Il y a quelques menus contextuels disponibles. Clic droit sur [X] (Close) de la fenêtre des sacs vous montrera un menu qui permet de montrer les sacs, les trier, montrer les clés, etc. Clic du milieu sur la mini carte permet d'afficher le micro menu."

	L.tutorial_step_5_line_1 = "Enfin, Tukui comprends des commandes utiles. Voici la liste ci-dessous."
	L.tutorial_step_5_line_2 = "/moveui vous permet de bouger beaucoup de cadres n'importe où à l'écran. /enable and /disable sont utilisés pour (dés)activer des addons. /rl recharge l'interface. /heal active l'interface de raid pour soigneur et /dps active l'interface raid pour dps/tank."
	L.tutorial_step_5_line_3 = "/tt vous permets du chuchoter à votre cible. /rc permet de demande si tout le monde est prêt. /rd dissoud un groupe ou raid. /bags affiche quelques options disponibles par ligne de commande. /ainv active l'auto-invitation en vous chuchotant. (/ainv off) pour le désactiver"
	L.tutorial_step_5_line_4 = "/gm affiche la fenêtre d'aide. /install, /resetui or /tutorial chargent cet installer. /frame affiche le nom et parent du cadre sous le curseur avec des informations supplémentaires."
	...
	L.tutorial_step_6_line_3 = "Vous pouvez maintenant continuer l'installation de l'interfface si ce n'est pas encore fait ou si vous voulez remettre le tout par défaut!"
	L.tutorial_step_6_line_4 = ""

	L.install_step_1_line_1 = "Ces étapes appliquerons les paramètres CVar corrects pour Tukui."
	L.install_step_1_line_2 = "La première étape applique les paramètres essentiels."
	L.install_step_1_line_3 = "C'est |cffff0000recommandé|r pour tout utilisateur, à moins que vous ne voulez appliquer qu'une partie spécifiques des paramètres."
	...
	L.install_step_2_line_1 = "La seconde étape appliquent les paramètres correct des fenêtres de discussion."
	...
	L.install_step_3_line_1 = "La troisième et dernière étape appliquent le positionnement des cadres par défaut."
	...
	L.install_step_4_line_4 = "Bon Jeu avec Tukui ! Et venez visitez http://www.tukui.org pour les MàJ et les informations sur votre interface Tukui !"
