...
if T.client == "deDE" then
    ...
    L.install_init_line_2 = "Du wirst mit einigen einfachen Schritten durch die Installation geführt. Bei jedem Schritt kannst du entscheiden, ob du die Standardeinstellugnen übernehmen oder überspringen möchstest."
    ...
    L.tutorial_step_4_line_1 = "Um festzulegen, wie viele Aktionsleisten du möchtest, bewege deine Maus an den linken oder rechten Rand der untersten Aktionsleiste. Mache das Gleiche auf der rechten Seite über den unteren und oberen Rand. Um Text aus dem Chat zu kopieren, klicke den Knopf, der beim Überfahren des Chatfensters mit der Maus in der rechten Ecke auftaucht."
    L.tutorial_step_4_line_2 = "Die Miniaturkarte ändert die Randfarbe. Sie ist Grün wenn du neue Post hast, Rot wenn du eine neue Kalendareinladung hast, und Orange bei beidem."
    ...
    L.tutorial_step_5_line_2 = "/moveui erlaubt dir das Bewegen vieler Fenster überall auf dem Bildschirm. /enable und /disable sind nützlich um schnell Addons ein- oder auszuschalten. /rl läd das Interface neu. /heal aktiviert das Heiler-Raidinterface und /dps aktiviert das Tank/DPS-Raidinterface."
    ...
    L.tutorial_step_5_line_4 = "/gm öffnet das Hilfe-Fenster. /install, /resetui oder /tutorial läd dieses Installationsprogramm. /frame zeigt den Namen des Fensters unter deinem Mauszeiger und dem des übergeordneten Fensters mit einigen anderen Informationen an."
    ...
    L.tutorial_step_6_line_3 = "Du kannst nun mit der Installation des Interfaces fortfahren, wenn diese noch nicht abgeschlossen ist oder du das Interface auf die Standardeinstellungen zurücksetzen willst."
    ...
    L.install_step_1_line_3 = "Dieser Schritt wird jedem Benutzer |cffff0000empfohlen|r, es sei denn, du willst nur spezielle Teile der Einstellungen aktivieren."
    ...
    L.install_step_3_line_2 = "Dieser Schritt ist für jeden neuen Charakter |cffff0000empfohlen|r ."
    ...
    L.install_step_4_line_2 = "Bitte klicke auf 'Abschliessen', um das Interface neu zu laden."
    ...
    L.install_button_finish = "Abschliessen"
    L.install_button_close = "Schliessen" 
end